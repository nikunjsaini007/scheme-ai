...
export function Assistant() {
  ...
  return (
    <section id="assistant" className="edge py-28 md:py-40">
      <SectionLabel index="06" title="AI assistant" />

      <div className="grid gap-14 lg:grid-cols-12">
        <div className="lg:col-span-4">
          <LineReveal className="display text-[22vw] leading-[0.84] lg:text-[9vw]" lines={["Just", "ask."]} />
          <Reveal delay={0.2}>
          ...
          <Reveal delay={0.3}>
            ...
            >
              ...
              <span className="text-[11px] font-semibold tracking-[0.18em] uppercase">
                {listening ? "Listening…" : "Ask Yojantra"}
              </span>
        ...
        <div className="lg:col-span-7 lg:col-start-6">
          <Reveal>
            <div className="ml-auto max-w-lg bg-ink px-6 py-5 text-ivory">
              <p className="eyebrow text-ivory/40">You</p>
          ...
          <Reveal delay={0.15}>
            <div className="mt-5 max-w-xl bg-white p-6 md:p-8">
                ...
                {TOP.map((s, i) => (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[11px] tracking-[0.14em] text-ink/40 uppercase">{s.category}</p>
                    </div>
              ...
              <p className="mt-6 text-[15px] text-ink/85">Want me to explain the best one?</p>
