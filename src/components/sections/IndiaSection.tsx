...
export function IndiaSection() {
  ...
  return (
    <section className="bg-ivory-deep py-28 md:py-40">
      <div className="edge">
        <SectionLabel index="07" title="Across India" />
        <LineReveal
          className="display text-[17vw] leading-[0.84] md:text-[9vw]"
          lines={["From", <span key="l" className="text-saffron">Ladakh</span>, "to Kerala."]}
        />
        ...
        <div className="mt-20 grid gap-14 lg:grid-cols-12">
          ...
          <div className="lg:col-span-6 lg:col-start-7">
            <AnimatePresence mode="wait">
              ...
              >
                <p className="display text-[13vw] leading-[0.86] md:text-[5.5vw]">{state.name}</p>
                <div className="mt-6 flex items-baseline gap-4">
                  <span className="display text-6xl text-saffron md:text-8xl">{state.count}</span>
                  <span className="eyebrow text-ink/45">schemes listed</span>
                </div>
