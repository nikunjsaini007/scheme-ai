...
export function WhoAreYou() {
  ...
  return (
    <section className="edge py-28 md:py-40">
      <SectionLabel index="01" title="Personalization" />
      <div className="grid gap-14 lg:grid-cols-12 lg:gap-10">
        <div className="lg:col-span-5">
          <LineReveal className="display text-[18vw] leading-[0.84] lg:text-[8vw]" lines={["Who", "are", "you?"]} />
          <Reveal delay={0.2}>
            <p className="mt-8 max-w-xs text-sm leading-relaxed text-ink/55">
              Pick the life you're living. We'll narrow thousands of schemes down to the ones written for people
              like you.
            </p>
          </Reveal>
        </div>
        ...
        <div className="lg:col-span-7">
            ...
            {personas.map((p, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-[11px] font-semibold tracking-[0.14em] uppercase">{p.label}</span>
                </motion.button>
              );
            })}
          </div>
          ...
          <AnimatePresence mode="wait">
            {active && (
              ...
              >
                <p className="eyebrow text-saffron">Show me what's available</p>
                <p className="display mt-3 text-3xl md:text-5xl">{active.label}</p>
                ...
                <p className="mt-6 text-[11px] text-ivory/40">Demo content — indicative categories, not a decision.</p>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
