    ...
    try {
      ...
      const annotated = (rows || []).map((r) => {
        try {
          ...
          return { ...r, deadlineDays, parsedBenefitAmount } as unknown as RecommendationRecord & { deadlineDays?: number | null; parsedBenefitAmount?: number | null };
        } catch {
          return r;
        }
      });
